    ...
    $.getJSON("test.json", function (data) {
        ...
        $.each(data.objekti, function (key, data) {
            ...
            if (data.sectors != undefined) {
                ...
                var startAngle = ((data.ANGLE1 / 180) + 0.5) * Math.PI;
                var endAngle = ((data.ANGLE2 / 180) + 0.5) * Math.PI;
                context.beginPath();
                context.arc(x, y, radius, startAngle, endAngle, counterClockwise);
                ...
                context.beginPath();
                var startAngle2 = ((data.ANGLE1 / 180) + 0.5) * Math.PI;
                var endAngle2 = ((data.ANGLE2 / 180) + 0.5) * Math.PI;
                ...
                context.beginPath();
                var startAngle3 = ((data.ANGLE1 / 180) + 0.5) * Math.PI;
                var endAngle3 = ((data.ANGLE2 / 180) + 0.5) * Math.PI;
            ...
            google.maps.event.addListener(marker, "mouseover", function (e) { elem.style.visibility = 'visible'; });
            google.maps.event.addListener(marker, "mouseout", function (e) { elem.style.visibility = 'hidden'; });
